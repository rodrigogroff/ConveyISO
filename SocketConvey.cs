...
label_40:
    ...
    private string montaVendaCE(ISO8583 regIso)
    {
      ...
      string registro = "05" + "CE" + "CE" + str.PadLeft(8, '0') + (regIso.trilha2.Trim().Length != 0 ? (regIso.trilha2.Trim().Length != 27 ? ("999999" + regIso.trilha2.Substring(17, 6) + regIso.trilha2.Substring(23, 6) + regIso.trilha2.Substring(29, 3)).PadLeft(27, '0') : regIso.trilha2.Trim()) : "999999999999999999999999999") + regIso.senha.PadLeft(16, '0') + regIso.valor.PadLeft(12, '0') + "01" + regIso.valor.PadLeft(12, '0');
